...
async def get_student_asr_results(student_id: str, video_id: Optional[str] = None, limit: int = 50):
    """Get ASR results for a student"""
    try:
        asr_results = await DatabaseManager.get_student_asr_results(student_id, video_id)
