        ...
        async with await DatabaseManager.get_connection() as db:
            ...
            for student in students:
                ...
                """, (student_id,)) as cursor:
                    ...
                    total_duration = duration_row['total_duration'] if duration_row else 0
                ...
                """, (student_id,)) as cursor:
                    ...
                    latest_activity = activity_row['timestamp'] if activity_row else None
                ...
                students_data.append(AdminStudentData(
                    id=student_dict['id'],
...
async def delete_student(student_id: str, admin_id: str):
    ...
    try:
        async with await DatabaseManager.get_connection() as db:
            ...
            await db.execute("DELETE FROM asr_results WHERE student_id = ?", (student_id,))
            await db.execute("DELETE FROM student_sessions WHERE student_id = ?", (student_id,))
            await db.execute("DELETE FROM video_progress WHERE student_id = ?", (student_id,))
